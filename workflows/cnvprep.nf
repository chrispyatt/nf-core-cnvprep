...
workflow CNVPREP {
    ...
    prepro_ints = GATK4_PREPROCESSINTERVALS ( [ meta_inp, capture_bed ], untar_out_ch.fasta, untar_out_ch.dict, untar_out_ch.fai ) { it -> it[1] }
    ...
    */
    ...
    indexes = GATK4_INDEXFEATUREFILE ( [ meta_inp, map_bed ] ) { it -> it[1] }
