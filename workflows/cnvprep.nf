...
workflow CNVPREP {
    ...
    prepro_ints = GATK4_PREPROCESSINTERVALS ( [ meta_inp, capture_bed ], untar_out_ch.fasta, untar_out_ch.dict, untar_out_ch.fai ).interval_list
    ...
    */
    ...
    indexes = GATK4_INDEXFEATUREFILE ( [ meta_inp, map_bed ] ).index
